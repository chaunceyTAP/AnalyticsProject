  ...
  if (typeof btSubscriberJson !== 'undefined') {
    ...
    $('#save-button').click(
      (window.preference_submit = function () {
        ...
        // htmlBlock = "<main style='background-color: #fff; line-height: 2rem; margin: 0 auto rem; max-width: 49rem; padding: clamp(0.5rem, 10%, 3rem) clamp(1.5rem, 5%, 6rem);display:flex;justify-content:center;'> <p style=''> Thank you for updating your preferences </p> </main>"
        // } );
        if (langPref == 'english') {
          $('main').html(
            "<main style='background-color: #fff; line-height: 3rem; margin: 0 auto rem; max-width: 49rem; padding: clamp(0.5rem, 10%, 3rem) clamp(1.5rem, 5%, 6rem);display:flex;justify-content:center;'> <p style='font-size:3rem !important;'> Thank you for updating your preferences </p> </main>"
          )
        } else {
          $('main').html(
            "<main style='background-color: #fff; line-height: 3rem; margin: 0 auto rem; max-width: 49rem; padding: clamp(0.5rem, 10%, 3rem) clamp(1.5rem, 5%, 6rem);display:flex;justify-content:center;'> <p style='font-size:3rem !important;'> Gracias por actualizar tus preferencias. </p> </main>"
          )
        }
      })
    )
